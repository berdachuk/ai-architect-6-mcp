...
| [M-04-retrieval-module.md](M-04-retrieval-module.md) | M3 | ⬜ Active |
| M-05-embedding-module | M4 | ⬜ Planned |
| M-06-mcp-module | M5 | ⬜ Planned |
| M-07-config-security | M6 | ⬜ Planned |
| M-08-e2e-smoke | M7 | ⬜ Planned |
| M-09-docker-quality-gate | M8 | ⬜ Planned |

Completed plans are moved to `archive/` when no longer active.

## Conventions

- Filename: `M-NN-short-topic.md` (zero-padded `NN`)
- Link requirement sections and test deliverables from [docs/04-testing.md](../../docs/04-testing.md)
